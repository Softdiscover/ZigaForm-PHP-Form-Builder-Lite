		...
		var zgfm_back_mgtranslate = function () {
			...
			zgfm_variable.externalVars = {};
			 ...
			 obj_elem.ajaxCallLoadTranslation();
				...
				$.ajax({
					type        : 'POST', 
					url: rockfm_vars.uifm_siteurl + 'addon_mgtranslate/zfaddn_mgtranslate_back/ajax_new_lang',
					data: {
							...
							$("#zgfm-mgtranslation-btn-createNewLang").click(function (event) {
								...
								if(parseInt(inputNewLang.length)===0){
									...
									return;
																...
																$.ajax({
									type        : 'POST', 
									url: rockfm_vars.uifm_siteurl + 'addon_mgtranslate/zfaddn_mgtranslate_back/ajax_create_lang',
									data: {
									...
									success: function(result){
										...
										$('#uifm_modal_msg .sfdc-modal-footer').html(result.data.html_footer);
											...
											var re_url = rockfm_vars.uifm_siteurl + 'addon_mgtranslate/zfaddn_mgtranslate_back/show_list';
				...
				$.ajax({
					type        : 'POST', 
					url: rockfm_vars.uifm_siteurl + 'addon_mgtranslate/zfaddn_mgtranslate_back/ajax_save_pofile',
				...
				$('#zgfm-page-translation textarea').on('focus', function() {
					...
					type: 'POST',
					dataType: 'json',
					url: rockfm_vars.uifm_siteurl + 'addon_mgtranslate/zfaddn_mgtranslate_back/ajax_load_pofile',
					data: {
