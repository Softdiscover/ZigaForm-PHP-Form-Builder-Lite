             ...
             arguments.callee.formvariables_generateTable=function (){
                ...
                $.each(temp, function(index, value) {
                    ...
                    switch(tmp_f_type){
                                            ...
                                            row_str+='<tr>';
                                            row_str+='<td>'+rocketform.formvariables_findFieldName(value)+'</td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_recvar id="'+value+'" atr1="label" atr2="'+tmp_f_type+'"]</textarea></td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_recvar id="'+value+'" atr1="value" atr2="'+tmp_f_type+'"]</textarea></td>';
                                            ...
                                            row_str+='<td>'+rocketform.formvariables_findFieldName(value)+'</td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_recvar id="'+value+'" atr1="label" atr2="'+tmp_f_type+'"]</textarea></td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_recvar id="'+value+'" atr1="input" atr2="'+tmp_f_type+'"]</textarea></td>';

                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_recvar id="'+value+'" atr1="qty" atr2="'+tmp_f_type+'"]</textarea></td>';
                                            row_str+='<td><textarea class="uifm_txtarea_var" onclick="this.select();">[uifm_wrap id="'+value+'"]here goes your content if field have some value. if no value, this will not appear.[/uifm_wrap]</textarea></td>';
                                            row_str+='</tr>';                
                                            break;
                                            case 21:
