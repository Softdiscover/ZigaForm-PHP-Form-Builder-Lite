...
;(function($){ "use strict";
    ...
    Iconpicker.DEFAULTS = {
        ...
        arrowNextIconClass: 'sfdc-glyphicon sfdc-glyphicon-arrow-right',
        arrowPrevIconClass: 'sfdc-glyphicon sfdc-glyphicon-arrow-left',
        cols: 4,
        icon: '',
        iconset: 'glyphicon',
        ...
        return this.each(function () {
            ...
            if (typeof option === 'string') {
                ...
                op = $.extend(op, {
                    ...
                    page: 1,
                    selected: -1,
                    table: $('<table class="table-icons sfdc-wrap"><thead></thead><tbody></tbody><tfoot></tfoot></table>')
                });
