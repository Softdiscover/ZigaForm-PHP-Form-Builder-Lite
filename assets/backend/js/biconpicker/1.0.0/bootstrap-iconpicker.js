    ...
    Iconpicker.prototype.changeList = function(page){
        ...
        for(var i = 0; i < op.rows; i++){
            ...
            for(var j = 0; j < op.cols; j++){
                ...
                var btn = $('<button class="sfdc-btn sfdc-btn-default btn-icon"></button>').hide();
                if(pos < op.icons.length){
                    var v = op.iconClassFix + op.icons[pos];
                    btn = $('<button class="sfdc-btn sfdc-btn-default btn-icon" value="' + v + '" title="' + v + '"><i class="' + op.iconClass + ' ' + v + '"></i></button>');
                }
        ...
        return this.each(function () {
            ...
            if (typeof option == 'string') data[option](params)
                ...
                op = $.extend(op, {
                    ...
                    page: 1,
                    selected: -1,
                    table: $('<table class="table-icons sfdc-wrap"><thead></thead><tbody></tbody></table>')
                });
