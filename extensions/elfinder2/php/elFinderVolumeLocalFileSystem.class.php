...
class elFinderVolumeLocalFileSystem extends elFinderVolumeDriver
{
    ...
    /**
     * Constructor
     * Exten doptions with required fields
     *
     * @author Dmitry (dio) Levashov
     */
    public function __construct()
    {
        ...
        $this->options['tmbPath'] = 'temp/.tmb';
        $this->options['quarantine'] = 'temp/.quarantine'; // quarantine folder name - required to check archive (must be hidden)
